...
local overseerSystem = require('systems/overseerSystem')(bluePrintSystem, mapSystem)
...
local settlerSystem = require('systems/settlerSystem')(mapSystem, jobSystem, itemSystem)
